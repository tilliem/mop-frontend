          ...
          <div className="row">
            ...
            <div id="navbar" className="navbar-collapse">
              <ul className="nav navbar-nav navbar-right nav-primary">
                <li><a href="http://petitions.moveon.org/create_start.html?source=topnav"><span className="icon icon-start"></span>Start a<br />petition</a></li>
                <li><a href="http://petitions.moveon.org/dashboard.html?source=topnav"><span className="icon icon-managepetitions"></span>Manage<br />Petitions</a></li>
